...
// setup x 
var xValue = function(d) { return d.Diabetes;}, // data -> value
    xScale = d3.scaleLinear().range([0, svgWidth]), // value -> display
    ...
    .enter().append("circle")
      ...
      .on("mouseover", function(d) {
          tooltip.transition()
               .duration(200)
               .style("opacity", .9);
          tooltip.html(d["Abbreviation"] + "<br/> (" + xValue(d) 
	        + ", " + yValue(d) + ")")
